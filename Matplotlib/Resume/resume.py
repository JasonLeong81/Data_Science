...
# Decorative Lines
ax.axvline(x=.5, ymin=0, ymax=1, color='black', alpha=0.0, linewidth=50)
plt.axvline(x=.99, color='purple', alpha=0.5, linewidth=300)
plt.axhline(y=.88, xmin=0, xmax=1, color='pink', linewidth=3)
